...
this.HalfWidth=Math.round(this.Width/2);this.HalfHeight=Math.round(this.Height/2);this.BakStep=this.Step;if(this.Width>0){this.ID.style.width=this.Width+"px";}if(this.Height>0){this.ID.style.height=this.Height+"px";}if(typeof this.ScrollStep!="number")this.ScrollStep=(this.Direction=="left" || this.Direction=="right")?this.Width:this.Height;var templateLeft="<table cellspacing='0' cellpadding='0' style='border-collapse:collapse;display:block'><tr><li><ul noWrap=true style='white-space: nowrap;word-break:keep-all;'>MSCLASS_TEMP_HTML</ul><li noWrap=true style='white-space: nowrap;word-break:keep-all;'>MSCLASS_TEMP_HTML</li><h2 noWrap=true style='white-space: nowrap;word-break:keep-all;'>MSCLASS_TEMP_HTML</h2><h2 noWrap=true style='white-space: nowrap;word-break:keep-all;'>MSCLASS_TEMP_HTML</h2><p noWrap=true style='white-space: nowrap;word-break:keep-all;'>MSCLASS_TEMP_HTML</p><p noWrap=true style='white-space: nowrap;word-break:keep-all;'>MSCLASS_TEMP_HTML</p><li noWrap=true style='white-space: nowrap;word-break:keep-all;'>MSCLASS_TEMP_HTML</li><li noWrap=true style='white-space: nowrap;word-break:keep-all;'>MSCLASS_TEMP_HTML</li><li noWrap=true style='white-space: nowrap;word-break:keep-all;'>MSCLASS_TEMP_HTML</li><ul noWrap=true style='white-space: nowrap;word-break:keep-all;'>MSCLASS_TEMP_HTML</ul></li></tr></table>";var templateTop="<div>MSCLASS_TEMP_HTML</div><div>MSCLASS_TEMP_HTML</div>";var msobj=this;msobj.tempHTML=msobj.ID.innerHTML;if(msobj.Direction=="top" || msobj.Direction=="bottom"){msobj.ID.innerHTML=templateTop.replace(/MSCLASS_TEMP_HTML/g,msobj.ID.innerHTML);}else{msobj.ID.innerHTML=templateLeft.replace(/MSCLASS_TEMP_HTML/g,msobj.ID.innerHTML);}
