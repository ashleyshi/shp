...
<TABLE border="0" width=400 align=center cellpadding=0 cellspacing=1  bgcolor=<%=tablebgcolor%>>
	<TR bgcolor=<%=trbgcolor%> height=25><TD align=center><FONT COLOR=red><B>管理员添加成功</B></FONT></TD>
	</TR>
	...
	<li><a href="../showAllNewsServlet">返回首页</a></li><br>
	<li><a href='addmaster.jsp'>继续添加管理员</a></li><br>
	<li><a href="mastermanage.jsp">返回管理员管理页面</a></li>
	</TD></TR>
</TABLE>
	<script>
	function 
